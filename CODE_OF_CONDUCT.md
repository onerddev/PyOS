...
- 📍 Publicação de informações privadas de outras pessoas (como endereço físico ou eletrônico) sem consentimento explícito
...
Este Código de Conduta se aplica tanto dentro dos espaços do projeto quanto em espaços públicos onde um indivíduo está representando o projeto ou sua comunidade. Exemplos de representação do projeto incluem o uso de um endereço de email oficial do projeto, postagem por meio de uma conta oficial de mídia social ou atuação como representante designado em um evento on-line ou off-line.
...
1. Recebimento do relatório (24h)
2. Investigação inicial (3-7 dias)
3. Contato com partes envolvidas
4. Decisão e ação (conforme apropriado)
5. Comunicação do resultado

### Quais são as consequências?

- **Avisos**: Comportamento levemente inadequado
- **Ban Temporário**: Assédio ou violações repetidas
- **Ban Permanente**: Comportamento severo ou abusivo persistente

### Pode haver reconciliação?

Sim. Após período de reflexão, indivíduos banidos podem solicitar revisão se demonstrarem crescimento.

---

## Comprometimento Comunitário

Esperamos que todos os membros da comunidade PyOS-Agent:

1. ✅ **Sejam respeitosos** com outros colaboradores
2. ✅ **Critiquem ideias, não pessoas**
3. ✅ **Ouçam ativamente** perspectivas diferentes
